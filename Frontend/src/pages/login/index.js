...
const LoginPage = () => {
  ...
  return (
    ...
    >
      ...
      >
        <Card style={{width: '50%', justifyContent: 'center', alignItems: 'center', flexShrink: 0}} sx={{borderRadius: '0 65px 65px 0', border: 'none', gap: '30px'}}>
          <Typography fontSize={75} fontWeight={500}>Bienvenid@</Typography>
      ...
      >
        <Card style={{width: '100%',  height: '100%',justifyContent: 'center', alignItems: 'center', flexShrink: 0}} sx={{borderRadius: '65px 0 0 65px', border: 'none', gap: '30px'}}>
          <Typography fontSize={75} fontWeight={500}>Bienvenid@</Typography>

          <Card style={{justifyContent: 'center', alignItems: 'center'}} sx={{padding: '40px', gap: '30px'}}>
          <Typography fontSize={45} fontWeight={500} color='#3E2F2F'>Registrarse</Typography>
            <Box component="form" sx={{width: '100%', maxWidth: 260, display: 'flex', flexDirection: 'column', gap: '20px' }}>
